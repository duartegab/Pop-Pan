...
E também na Tabela RedesSociais_Artistas:
```sql
...
Agora, iremos inserir os dados na Tabela Ingressos (por se tratar de muitos dados, colocamos apenas os ingressos dos 10 primeiros compradores, de cada edição):
```sql
...
Também iremos inserir os dados na Tabela Apresentacoes:
```sql
...
E também na Tabela Ingressos_Apresentacoes:
```sql
...
![10.4](https://github.com/duartegab/Pop-Pan/blob/main/PrintsPopPan/consulta%2010%204.0.png)
...
* Desde já conto o apoio de vocês e peço que me sigam, para acompanharem junto comigo meu primeiro Projeto Integrador [Dream Builder](https://github.com/duartegab/Dream-Builder) feito com a [Caroline Avelar](https://github.com/CarolineAvelar), que terá relação com minhas disciplinas-chave do meu 1º Semestre (Engenharia de Software 1, Desenvolvimento Web 1 e Design Digital)! 📢;
